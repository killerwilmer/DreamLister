...
class MainVC: UIViewController, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    // this for select item in the list
    ...
    func generateTestData() {
        ...
        item.price = 1800
        item.details = "I can't wait until the September event, I hope they relase new MBPs"
        ...
        item3.price = 110000
        item3.details = "Oh man this is a beatiful car. And one day , I willl own it"
